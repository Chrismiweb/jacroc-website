...
function OurTeam() {
  ...
  return (
    <div id ="team" className='w-[100%] gap-[30px] bg-orange-50 py-[50px] flex flex-col justify-center items-center'>
        {/* <div className='w-[80%]'>
